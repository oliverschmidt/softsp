...
With this firmware, the A2Pico emulates a DIY [softSP](http://www.mfa2lab.com/opcart/index.php?route=product/product&product_id=56) card that allows to use SmartPort devices connected to a Disk II controller card in slot 6.
